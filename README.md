...
<p align="center"><em>Left: 2D slice through a 3D electrostatic potential field (SOR solver, $N=1000^3$). Right: Mean squared displacement confirming Einstein's diffusion law $\langle r^2 \rangle = 6Dt$.</em></p>
